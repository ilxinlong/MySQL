...
```sql
mysql> select * from sys.x$innodb_lock_waits LIMIT 1\G;
*************************** 1. row ***************************
...
mysql> select stmt.SQL_TEXT as sql_text,
...
#### [CPU高利用率及IO高负载定位分析 ](https://www.cnblogs.com/broadway/p/16805847.html)
